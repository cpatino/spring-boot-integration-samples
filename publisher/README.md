...
3. Use the ```SqsTemplate``` (Autoconfigured by spring-cloud-aws-starter-sqs) to send messages to the SQS queue. This allows the application to publish messages to the SQS queue that is simulated by 'localstack'.
